angular.module('sa.directives', [])
    .directive('saGrid', ['$log', '$window', function ($log, $window) {
        ...
        return {
            ...
            link: function (scope, element) {
                ...
                scope.$watch('idProperty', function (value) {
                    $log.debug('idProperty changed', value);
                    refresh();
                });

                scope.$watchCollection('datasource', function (data) {
    ...
    .directive('saAjaxGrid', ['$http', '$q', '$log', '$timeout', '$window',
